        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form method="post" action="{{ route('owner.products.update', ['product' => $product->id]) }}">
            ...
            <div class="-m-2">
              ...
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
                  <label for="like" class="leading-7 text-sm text-gray-600">いいね数</label>
                  <div id="like" class="w-full bg-gray-100 bg-opacity-50 rounded text-base outline-none text-gray-700 py-1 px-3 leading-8">{{ $likes }}</div>
                </div>
              </div>
              <div class="p-2 w-1/2 mx-auto">
                <div class="relative">
